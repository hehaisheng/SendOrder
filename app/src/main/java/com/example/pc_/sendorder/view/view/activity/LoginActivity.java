...
public class LoginActivity extends BaseActivity implements View.OnClickListener{
    ...
    public void initData() {
        ...
        sellerName=sharedPreferences.getString("SellerName","0");
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.login_clickText:
                ...
                String nameString1=loginNameEdit.getText().toString();
                if(accountString1.equals(account)&&passwordString1.equals(password)&&nameString1.equals(sellerName)){
                    ...
                    if(!hasAccount){
                        ...
                        Toast.makeText(this,"重新输入账号,密码,派送名",Toast.LENGTH_SHORT).show();
                    }
            ...
            case R.id.register_clickText:
                ...
                String nameString=loginNameEdit.getText().toString();
                ...
                if(nameString.length()<1){
                    Toast.makeText(this,"派送名长度应该大于1",Toast.LENGTH_SHORT).show();
                    break;
                }
