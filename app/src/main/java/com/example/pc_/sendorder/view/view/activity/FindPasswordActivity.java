...
public class FindPasswordActivity extends BaseActivity {
    ...
    @BindView(R.id.find_nameEdit)
    EditText findNameEdit;
    ...
    public String  editShopNameString;
        ...
        findClickText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(hasAccount){
                    ...
                    editShopNameString=findNameEdit.getText().toString();
                    if(!editAccountString.equals(account)){
                        ...
                        }else if(editShopNameString.length()<1){
                            Toast.makeText(FindPasswordActivity.this,"派送名长度应该大于1",Toast.LENGTH_SHORT).show();
                        }else{
                            SharedPreferences.Editor editor=sharedPreferences.edit();
                            editor.putString("Password",editPasswordString);
                            editor.putString("SellerName",editShopNameString);
                            editor.apply();
